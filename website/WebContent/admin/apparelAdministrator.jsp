                    ...
                    <div class="row">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                              <label for="inputAddress">Articuled code</label>
                              <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St">
                            </div>
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="inputAddress2">Original prince</label>
                                  ...
                                  <div class="form-group col-md-6">
                                    <label for="inputCity">Territory</label>
